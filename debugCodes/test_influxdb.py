...
try:
    from influxdb_sender import init_influxdb, send_measurement_to_influx, close_influxdb, test_influx_connection
...
def test_complete_measurement():
    ...
    measurement_data = {
        ...
        'T0': 28.5, 'T1': 29.1, 'T2': 27.8, 'T3': 30.2, 'T4': 28.9,
        'T5': 29.3, 'T6': 27.5, 'T7': 31.1, 'T8': 28.7, 'T9': 29.8,
        'T10': 30.5, 'T11': 28.2, 'T12': 29.6, 'T13': 27.9, 'T14': 30.8,
        'T15': 28.1, 'T16': 29.4, 'T17': 28.6, 'T18': 30.1, 'T19': 29.0,
